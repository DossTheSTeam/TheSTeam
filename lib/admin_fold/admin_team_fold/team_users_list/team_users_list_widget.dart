...
class TeamUsersListWidget extends StatefulWidget {
  const TeamUsersListWidget({
    super.key,
...
class _TeamUsersListWidgetState extends State<TeamUsersListWidget> {
  late TeamUsersListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TeamUsersListModel());
  }
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        teamUsersListTeamsRecord.members.length
                                            .toString(),
                                        '0',
                                      ),
                                        ...
                                        children: List.generate(
                                          ...
                                          final columnUsersRecord =
                                              columnUsersRecordList[
                                                  columnIndex];
                                          return Visibility(
                                            visible: teamUsersListTeamsRecord
                                                .members
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      teamUsersListTeamsRecord.fans.length
                                          .toString(),
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .titleMedium
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        teamUsersListTeamsRecord.blocks.length
                                            .toString(),
                                        '0',
                                      ),
                                      textAlign: TextAlign.center,
