                                        ...
                                        AuthUserStreamWidget(
                                          builder: (context) => Text(
                                            FFLocalizations.of(context).getText(
                                              'ejul6ptw' /* Noter mes co-équipiers */,
                                            ),
...
compañeros */
                                      ...
                                      if (valueOrDefault(
                                        ...
                                        AuthUserStreamWidget(
                                          builder: (context) => Text(
                                            FFLocalizations.of(context).getText(
                                              'd4trpc6i' /* Valuta i miei compagni
di squa... */
                                              ,
                                            ),
                                            textAlign: TextAlign.center,
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        FFLocalizations.of(context).getText(
                                          '5dc68hv3' /* Lista de participantes */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .headlineSmall
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        FFLocalizations.of(context).getText(
                                          'lxzzdt4h' /* Elenco dei partecipanti */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .headlineSmall
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        FFLocalizations.of(context).getText(
                                          't5hol9hw' /* Lista de participantes */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .headlineSmall
                                        ...
                                        children: [
                                          if ((valueOrDefault(
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '5rrmql2p' /* Cliquer sur les icones pour at... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                          ...
                                          if ((valueOrDefault(
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'g2x48b5t' /* Click on the icons to assign t... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                          ...
                                          if (valueOrDefault(
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '9is6zijv' /* Klicken Sie auf die Symbole, u... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                          ...
                                          if (valueOrDefault(
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '48pcajk0' /* Haga clic en los iconos para a... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                          ...
                                          if (valueOrDefault(
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'j4ho6a7m' /* Fare clic sulle icone per asse... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                          ...
                                          if (valueOrDefault(
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '6zn9fhk0' /* Clique nos ícones para atribui... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                            ...
                            Padding(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  if (ratingPlayersPageEventsRecord
                                          .teamdomRef ==
                                                  ...
                                                  if (valueOrDefault(
                                                    ...
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'fbioqecr' /* Convalida la valutazione */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                                  ...
                                                  if (valueOrDefault(
                                                    ...
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'o7wkmolx' /* Validar classificação */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
