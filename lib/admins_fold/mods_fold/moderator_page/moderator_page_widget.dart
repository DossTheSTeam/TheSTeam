                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '8zaqqmu5' /* Discussion Moderateurs */,
                            ),
                            maxLines: 1,
                            style: FlutterFlowTheme.of(context)
                                .headlineSmall
                            ...
                            return Row(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'kehc05l9' /* Ecrire un conseil / stratégie */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelLarge
                                        .override(
