...
class StatsTeamsEventWidget extends StatefulWidget {
  const StatsTeamsEventWidget({
    super.key,
  ...
  @override
  State<StatsTeamsEventWidget> createState() => _StatsTeamsEventWidgetState();
}

class _StatsTeamsEventWidgetState extends State<StatsTeamsEventWidget>
    with TickerProviderStateMixin {
  late StatsTeamsEventModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StatsTeamsEventModel());
  }
                                                            ...
                                                            if (containerEventsRecord
                                                              ...
                                                              Text(
                                                                valueOrDefault<
                                                                    String>(
                                                                  functions
                                                                      .limitOf2Decimal(functions.averageETeamPoints(
                                                                          columnTeamsRecord
                                                                              .points,
                                                                          columnTeamsRecord
                                                                              .totalGames)!)
