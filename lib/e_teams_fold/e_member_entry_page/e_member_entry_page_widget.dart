...
class EMemberEntryPageWidget extends StatefulWidget {
  const EMemberEntryPageWidget({
    super.key,
...
class _EMemberEntryPageWidgetState extends State<EMemberEntryPageWidget> {
  late EMemberEntryPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EMemberEntryPageModel());
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image.network(
                                  eMemberEntryPageTeamsRecord.logo,
                                  width: 300.0,
                                  height: 200.0,
                          ...
                          Text(
                            eMemberEntryPageTeamsRecord.name,
                            maxLines: 1,
                            style: FlutterFlowTheme.of(context)
                                .titleSmall
                                .override(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await MyNotificationsRecord.createDoc(
                                      eMemberEntryPageTeamsRecord.boss!)
                                  .set({
