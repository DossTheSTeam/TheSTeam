                    ...
                    children: [
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          Text(
                                            columnUsersRecord.stock.toString(),
                                            maxLines: 1,
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                      ...
                      StreamBuilder<TeamsRecord>(
                        stream: TeamsRecord.getDocument(
                            bossEMemberEntryPageMyNotificationsRecord.teamRef!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                      ...
                      StreamBuilder<UsersRecord>(
                        stream: UsersRecord.getDocument(
                            bossEMemberEntryPageMyNotificationsRecord.userRef!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                                      ...
                                      onPressed: () async {
                                        ...
                                        await bossEMemberEntryPageMyNotificationsRecord
                                          ...
                                          esportValue: valueOrDefault(
                                              currentUserDocument?.esportValue,
                                              ''),
                                        ));
                      ...
                      FlutterFlowDropDown<String>(
                        ...
                        optionLabels: const [
                          ...
                          'Pas ce que l\'on recherche (âge, afffinités, ..)',
                          'Vous avez déjà un club'
                        ],
                        onChanged: (val) =>
