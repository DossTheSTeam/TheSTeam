                              ...
                              child: Column(
                                ...
                                children: [
                                  if ((valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'En attente de nouveaux parieurs',
                                        style: FlutterFlowTheme.of(context)
                                            .labelSmall
                                            .override(
                                              fontFamily:
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'In attesa di nuovi scommettitori',
                                        style: FlutterFlowTheme.of(context)
                                            .labelSmall
                                            .override(
                                              fontFamily:
