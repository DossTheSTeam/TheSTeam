                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(AddEventPageWidget.routeName);
                                },
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'bics63ju' /* Créer une rencontre */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                                      .override(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(ListEventsAdminWidget.routeName);
                              },
                              child: Icon(
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(AdminRankPageWidget.routeName);
                                },
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '86ayqfok' /* Admin Classement Parieurs */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                                      .override(
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '2pevzw6u' /* Voir utilisateurs sous app */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                                      .override(
                      ...
                      Padding(
                        ...
                        child: StreamBuilder<List<TeamsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<TeamsRecord> rowCreaTeamTeamsRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final rowCreaTeamTeamsRecord =
                                rowCreaTeamTeamsRecordList.isNotEmpty
                                    ? rowCreaTeamTeamsRecordList.first
                                    : null;
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'jbujm4tx' /* Créer un sondage/news */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
