                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Artículo 1 – En la presente solicitud...\ntodo es publico',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Articolo 1 – Nella presente applicazione...\nTutto è pubblico',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Artículo 3 – Objeto de la solicitud',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Articolo 3 – Oggetto della domanda',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Artigo 3º – Finalidade da Aplicação',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => Text(
                                          'Ver información de clasificación',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                                fontFamily:
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => Text(
                                          'Vedi informazioni sulla classifica',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                                fontFamily:
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      AuthUserStreamWidget(
                                        builder: (context) => Text(
                                          'Veja informações de classificação',
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium
                                              .override(
                                                fontFamily:
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Artículo 6 – Normas de la comunidad',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Articolo 6 – Regole della comunità',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Artigo 6º – Regras da Comunidade',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if ((valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Article 7 – Modification of the T&Cs',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Artículo 7 – Modificación de los Términos y Condiciones',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Articolo 7 – Modifica delle Condizioni Generali',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
                                  ...
                                  if (valueOrDefault(
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        'Artigo 7º – Modificação dos Termos e Condições',
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                                              fontFamily:
