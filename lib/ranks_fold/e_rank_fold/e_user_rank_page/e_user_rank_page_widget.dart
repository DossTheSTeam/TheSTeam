                    ...
                    builder: (context) => SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                                          ...
                                          children: [
                                            if ((valueOrDefault(
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'spf5acgt' /* Filtrer les E Teams selon... */,
                                                ),
                                            ...
                                            if (valueOrDefault(
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'ecwjw7ej' /* Filtern Sie E-Teams nach ... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    _model.showESportFilter = 'esport.football';
                                    safeSetState(() {});
                                  },
                                  child: Icon(
                                ...
                                InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    _model.showESportFilter = 'esport.war';
                                    safeSetState(() {});
                                  },
                                  child: FaIcon(
                          ...
                          if (_model.showESportFilter != null &&
                              _model.showESportFilter != '')
                            Row(
                              mainAxisSize: MainAxisSize.max,
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  ...
                                  FutureBuilder<int>(
                                    future: queryUsersRecordCount(
                                      queryBuilder: (usersRecord) => usersRecord
                                          ...
                                          .where(
                                            'esport_value',
                                            isEqualTo: _model.showESportFilter,
                                          ),
                                    ),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
