...
class _RankTypstersPageWidgetState extends State<RankTypstersPageWidget> {
  late RankTypstersPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RankTypstersPageModel());
  }
