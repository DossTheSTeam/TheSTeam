...
class EventMessagesRecord extends FirestoreRecord {
  ...
  static Query<Map<String, dynamic>> collection([DocumentReference? parent]) =>
      parent != null
          ? parent.collection('event_messages')
          : FirebaseFirestore.instance.collectionGroup('event_messages');

  static DocumentReference createDoc(DocumentReference parent, {String? id}) =>
      parent.collection('event_messages').doc(id);
...
class EventMessagesRecordDocumentEquality
  ...
  @override
  int hash(EventMessagesRecord? e) => const ListEquality().hash([
        e?.commUser,
        e?.text,
        e?.createdTime,
        e?.image,
