                                                            ...
                                                            if (valueOrDefault(
                                                              ...
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'qry54hn9' /* Durchschnittliche Bewertung */,
                                                                ),
                                                                textAlign:
                                                                    TextAlign
                                                                        .center,
                            ...
                            children: [
                              AuthUserStreamWidget(
                                builder: (context) => Text(
                                  valueOrDefault<String>(
                                    valueOrDefault(
                                            currentUserDocument?.numPenalities,
                                            0)
                                        .toString(),
                                    '0',
                                  ),
