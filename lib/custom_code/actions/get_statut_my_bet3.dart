...
Future<bool?> getStatutMyBet3(DocumentReference myBetRef) async {
  try {
    ...
    DocumentReference? bet2Ref = myBetSnapshot.get('bet2');
    DocumentReference? bet3Ref = myBetSnapshot.get('bet3');

    // Créer une liste de références de paris non nulles
    List<DocumentReference> validBetRefs = [
      if (bet1Ref != null) bet1Ref,
      if (bet2Ref != null) bet2Ref,
      if (bet3Ref != null) bet3Ref,
    ];
