...
import 'number_phone_model.dart';
export 'number_phone_model.dart';
...
class _NumberPhoneWidgetState extends State<NumberPhoneWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NumberPhoneModel());
