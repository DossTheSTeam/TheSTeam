...
class _ModNotifsListWidgetState extends State<ModNotifsListWidget> {
  late ModNotifsListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModNotifsListModel());
  }
                    ...
                    child: StreamBuilder<List<MyNotificationsRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<MyNotificationsRecord>
                            columnMyNotificationsRecordList = snapshot.data!;
                        ...
                        return Column(
                          ...
                          children: List.generate(
                            ...
                            final columnMyNotificationsRecord =
                                columnMyNotificationsRecordList[columnIndex];
                            return Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Padding(
                                  ...
                                  child: StreamBuilder<UsersRecord>(
                                    stream: UsersRecord.getDocument(
                                        columnMyNotificationsRecord.userRef!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                                    ...
                                    children: [
                                      if (columnMyNotificationsRecord
                                        ...
                                        StreamBuilder<EventMessagesRecord>(
                                          stream:
                                              EventMessagesRecord.getDocument(
                                                  columnMyNotificationsRecord
                                                      .eventMessage!),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            ...
                                            final columnEventMessagesEventMessagesRecord =
                                                snapshot.data!;
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: StreamBuilder<
                                                      UsersRecord>(
                                                    stream: UsersRecord.getDocument(
                                                        columnEventMessagesEventMessagesRecord
                                                            .commUser!),
                                                    builder:
                                                        (context, snapshot) {
                                                      // Customize what your widget looks like when it's loading.
                                      ...
                                      if (columnMyNotificationsRecord.post !=
                                          null)
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                      ...
                                      if (columnMyNotificationsRecord
                                        ...
                                        Padding(
                                          ...
                                          child:
                                            ...
                                            stream:
                                                PostMessagesRecord.getDocument(
                                                    columnMyNotificationsRecord
                                                        .postMessage!),
                                            builder: (context, snapshot) {
                                              // Customize what your widget looks like when it's loading.
                                              ...
                                              final columnPostMessagesPostMessagesRecord =
                                                  snapshot.data!;
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: StreamBuilder<
                                                      ...
                                                      stream: UsersRecord
                                                          .getDocument(
                                                              columnPostMessagesPostMessagesRecord
                                                                  .commUser!),
                                                      builder:
                                                          (context, snapshot) {
                                                        // Customize what your widget looks like when it's loading.
                                      ...
                                      if (columnMyNotificationsRecord.teamRef !=
                                          null)
                                        Padding(
                                          padding:
                                              const EdgeInsetsDirectional.fromSTEB(
                                                ...
                                                child: Padding(
                                                  padding: const EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          10.0, 0.0, 0.0, 10.0),
                                                  child: Text(
                                                    'Veut devenir membre de ce club',
                                ...
                                if (columnMyNotificationsRecord.eEvent != null)
                                  StreamBuilder<EventsRecord>(
                                    stream: EventsRecord.getDocument(
                                        columnMyNotificationsRecord.eEvent!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
