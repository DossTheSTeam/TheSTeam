...
class ListPostsMyTeamsWidget extends StatefulWidget {
  ...
  static String routeName = 'ListPostsMyTeams';
  static String routePath = '/listPostsMyTeams';
...
As minhas equipes */
                ...
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(10.0, 90.0, 1.0, 70.0),
                  child: Column(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      Align(
                                                                          ...
                                                                          Column(
                                                                            ...
                                                                            children: [
                                                                              Align(
                                                                                ...
                                                                                child: Padding(
                                                                                  padding: EdgeInsetsDirectional.fromSTEB(70.0, 3.0, 0.0, 0.0),
                                                                                  child: SingleChildScrollView(
                                                                                    ...
                                                                                    child: Row(
                                                                                      ...
                                                                                      crossAxisAlignment: CrossAxisAlignment.start,
                                                                                      children: [
                                                                                        if (!columnTeamsTeamsRecord.blocks.contains(currentUserReference))
                                                                                          InkWell(
                                                                                            splashColor: Colors.transparent,
                                                                                            focusColor: Colors.transparent,
                                                                                            hoverColor: Colors.transparent,
                                    ...
                                    AuthUserStreamWidget(
                                      builder: (context) => Text(
                                        FFLocalizations.of(context).getText(
                                          '3cdgk9mq' /* Rechercher des équipes */,
                                        ),
