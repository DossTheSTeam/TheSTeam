              ...
              child: Padding(
                ...
                child: StreamBuilder<PostMessagesRecord>(
                  stream: PostMessagesRecord.getDocument(
                      signalPostMessagePageMyNotificationsRecord.postMessage!),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                      return Center(
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  10.0, 0.0, 0.0, 0.0),
                              child: Text(
                                signalPostMessagePageMyNotificationsRecord.text,
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                                      fontFamily: 'Poppins',
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await columnPostMessagesRecord.reference
                                    ...
                                    ...mapToFirestore(
                                      {
                                        'num_redcards': FieldValue.increment(1),
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await columnPostMessagesRecord.commUser!
                                    ...
                                    ...mapToFirestore(
                                      {
                                        'stock': FieldValue.increment(-(10.0)),
                                        'num_penalities':
