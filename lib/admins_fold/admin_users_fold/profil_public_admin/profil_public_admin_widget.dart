                                  ...
                                  child: Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: CachedNetworkImage(
                                        ...
                                        fadeOutDuration:
                                            Duration(milliseconds: 500),
                                        imageUrl: profilPublicAdminUsersRecord
                                            .photoUrl,
                                        width: 100.0,
                                        height: 100.0,
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            await Clipboard.setData(ClipboardData(
                                text: profilPublicAdminUsersRecord.uid));
                            await showModalBottomSheet(
...
suspension */
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  profilPublicAdminUsersRecord.betWin
                                      .toString(),
                                  '0',
                                ),
                                style: FlutterFlowTheme.of(context)
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                valueOrDefault<String>(
                                  profilPublicAdminUsersRecord.betLoose
                                      .toString(),
                                  '0',
                                ),
                                style: FlutterFlowTheme.of(context)
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              '3b554925' /* Changer le classement parieur */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                              ...
                              children: [
                                ...
                                if (_model.dropLigueValue == 'pro')
                                  Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                      if (profilPublicAdminUsersRecord
                                              .rankValue ==
                                          'amateur')
                                        Column(
                                          mainAxisSize: MainAxisSize.max,
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'gx5zj0cj' /*  Legende vers Champion */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                ...
                                if (_model.dropLigueValue == 'legende')
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'yoadd8ax' /* Champion vers Legende */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                        ...
                        child: Row(
                          ...
                          children: [
                            FlutterFlowDropDown<String>(
                              ...
                              options:
                                  List<String>.from(['suspendu', 'moderateur']),
                              optionLabels: [
                                FFLocalizations.of(context).getText(
                                  'ex1tljkq' /* Suspendu */,
                                ),
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'rai3qhuq' /* Changer le Statut Admin Sport */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
