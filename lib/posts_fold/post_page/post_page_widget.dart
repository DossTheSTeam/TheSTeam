...
import '/posts_fold/copy_text_post/copy_text_post_widget.dart';
import '/posts_fold/modif_post/modif_post_widget.dart';
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  if (postPagePostsRecord.eventRef != null)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 20.0),
                                      child: StreamBuilder<EventsRecord>(
                                        stream: EventsRecord.getDocument(
                                            postPagePostsRecord.eventRef!),
                                        builder: (context, snapshot) {
                                          // Customize what your widget looks like when it's loading.
                                          if (!snapshot.hasData) {
                                            return Center(
                                  ...
                                  if (postPagePostsRecord.youtubeVideo != '')
                                    FlutterFlowYoutubePlayer(
                                      url: postPagePostsRecord.youtubeVideo,
                                      autoPlay: false,
                                      looping: true,
                                      mute: false,
                                      showControls: true,
