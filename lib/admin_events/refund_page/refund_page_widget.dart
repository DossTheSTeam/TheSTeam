...
import 'refund_page_model.dart';
export 'refund_page_model.dart';
...
class RefundPageWidget extends StatefulWidget {
  ...
  static String routeName = 'RefundPage';
  static String routePath = '/refundPage';

  @override
  State<RefundPageWidget> createState() => _RefundPageWidgetState();
}

class _RefundPageWidgetState extends State<RefundPageWidget> {
  late RefundPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RefundPageModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EventsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final refundPageEventsRecord = snapshot.data!;
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            refundPageEventsRecord.reference.id,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                          ...
                          if (refundPageEventsRecord.sportValue ==
                              'sports.meca')
                            Text(
                              refundPageEventsRecord.week,
                              maxLines: 1,
                              style: FlutterFlowTheme.of(context)
                                  .titleSmall
                                  .override(
                                ...
                                children: [
                                  StreamBuilder<TeamsRecord>(
                                    stream: TeamsRecord.getDocument(
                                        refundPageEventsRecord.teamdomRef!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                                  ...
                                  StreamBuilder<TeamsRecord>(
                                    stream: TeamsRecord.getDocument(
                                        refundPageEventsRecord.teamextRef!),
                                    builder: (context, snapshot) {
                                      // Customize what your widget looks like when it's loading.
                                      if (!snapshot.hasData) {
                                        return Center(
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'clgtah32' /* Parieurs sur cette rencontre */,
                                ),
                                textAlign: TextAlign.center,
                                maxLines: 2,
                                style: FlutterFlowTheme.of(context)
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<List<BetsRecord>>(
                              stream: queryBetsRecord(
                                parent: refundPageEventsRecord.reference,
                                                  ...
                                                  children: List.generate(
                                                    ...
                                                    final columnUsersRecord =
                                                        columnUsersRecordList[
                                                            columnIndex];
                                                    return Visibility(
                                                      visible: columnStatsBetsBetsRecord
                                                          .bettors
                                                          .contains(
                                                              columnUsersRecord
                                                                  .reference),
                                                              ...
                                                              children: [
                                                                ...
                                                                StreamBuilder<
                                                                  ...
                                                                  stream:
                                                                    ...
                                                                    queryBuilder:
                                                                        (myBetsRecord) =>
                                                                            myBetsRecord.where(Filter.or(
                                                                      Filter(
                                                                        'bet1',
                                                                        isEqualTo:
                                                                            columnStatsBetsBetsRecord.reference,
                                                                      ),
                                                                      Filter(
                                                                        'bet2',
                                                                        isEqualTo:
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    final rowMyBetsRecord = rowMyBetsRecordList
                                                                            .isNotEmpty
                                                                        ? rowMyBetsRecordList
                                                                            .first
                                                                        : null;
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                              ...
                                                                              await columnUsersRecord.reference.update({
                                                                                ...mapToFirestore(
                                                                                  {
                                                                                    'stock': FieldValue.increment(rowMyBetsRecord!.mise),
