              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 30.0, 10.0),
                      child: Row(
                        mainAxisSize: MainAxisSize.max,
                        ...
                        children: [
                          AuthUserStreamWidget(
                            builder: (context) => Text(
                              valueOrDefault<String>(
                                valueOrDefault(currentUserDocument?.stock, 0.0)
                                    .toString(),
                                '900',
                              ),
                              style: FlutterFlowTheme.of(context)
                      ...
                      Padding(
                        ...
                        child: FlutterFlowDropDown<double>(
                          controller: _model.dropPriceValueController ??=
                            ...
                            _model.dropPriceValue ??= 1.99,
                          ),
                          options: List<double>.from([1.99, 4.99, 9.99, 19.99]),
                          optionLabels: const [
                            '1.99 €',
                            '4.99 €',
                            '9.99 €',
