...
class _LiguesRankPageWidgetState extends State<LiguesRankPageWidget> {
  late LiguesRankPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LiguesRankPageModel());
  }
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                FlutterFlowDropDown<String>(
                                                  controller: _model
                                                          .dropCoupeFootValueController ??=
                                                      FormFieldController<
                                                          String>(
                                                    _model.dropCoupeFootValue ??=
                                                        '',
                                                  ),
                                                  options: List<String>.from([
                                                    'champions.league',
                                        ...
                                        if (_model.showSport == 'basketball')
                                          FlutterFlowDropDown<String>(
                                            controller: _model
                                        ...
                                        if (_model.showSport == 'hockey')
                                          FlutterFlowDropDown<String>(
                                            ...
                                            optionLabels: [
                                              ...
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '7fqrlf9y' /* Gazon Elite H */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'puph6316' /* Gazon Elite F */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'irn52j74' /* Salle Elite H */,
                                              ),
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'sftfubgj' /* Salle Elite F */,
                                              )
                                            ],
                                            onChanged: (val) async {
                                              safeSetState(() => _model
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          if (_model.showLigue == 'bundesliga')
                                            Container(
                                              width: 35.0,
                                              height: 35.0,
                                              decoration: BoxDecoration(
