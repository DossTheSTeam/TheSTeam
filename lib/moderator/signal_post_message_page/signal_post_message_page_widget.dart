...
class SignalPostMessagePageWidget extends StatefulWidget {
  const SignalPostMessagePageWidget({
    super.key,
  ...
  State<SignalPostMessagePageWidget> createState() =>
      _SignalPostMessagePageWidgetState();
}

class _SignalPostMessagePageWidgetState
    extends State<SignalPostMessagePageWidget> {
  late SignalPostMessagePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignalPostMessagePageModel());
  }
              ...
              body: SafeArea(
                ...
                child: Align(
                  ...
                  child: Padding(
                    ...
                    child: StreamBuilder<PostMessagesRecord>(
                      stream: PostMessagesRecord.getDocument(
                          signalPostMessagePageMyNotificationsRecord
                              .postMessage!),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        if (!snapshot.hasData) {
                        ...
                        final columnPostMessagesRecord = snapshot.data!;
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'fp2mcb28' /* veut mettre un carton rouge à */,
                                    ),
                              ...
                              Padding(
                                ...
                                child: StreamBuilder<UsersRecord>(
                                  stream: UsersRecord.getDocument(
                                      columnPostMessagesRecord.commUser!),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'z3onf7uq' /* Pour la raison suivante */,
                                    ),
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'ac5osojr' /* Dans le commentaire suivant */,
                                    ),
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  if (columnPostMessagesRecord.audio != '')
                                    Align(
                                        ...
                                        child: Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: FlutterFlowAudioPlayer(
                                              audio: Audio.network(
                                                columnPostMessagesRecord.audio,
                                                metas: Metas(
                                                  title: ' ',
                                                ),
                                              ),
                                  ...
                                  Align(
                                    ...
                                    child: Text(
                                      dateTimeFormat(
                                        "d/M H:mm",
                                        columnPostMessagesRecord.createdTime!,
                                        locale: FFLocalizations.of(context)
                                            .languageCode,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await columnPostMessagesRecord.reference
                                          .update({
                                        ...mapToFirestore(
                                          {
                                            'num_redcards':
                                      ...
                                      await columnPostMessagesRecord.commUser!
                                          .update({
                                        ...mapToFirestore(
                                          {
                                            'stock':
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '73jfh9m2' /* pour la raison suivante */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                              ...
                              FlutterFlowDropDown<String>(
                                ...
                                optionLabels: [
                                  FFLocalizations.of(context).getText(
                                    'lau5sk4y' /* Manque d'elements */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    '4nw9nsfq' /* Chambrage  */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'jgfoxmvf' /* Pas mentionnés dans CGU */,
                                  )
                                ],
