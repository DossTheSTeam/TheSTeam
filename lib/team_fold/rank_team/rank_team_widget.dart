...
import 'rank_team_model.dart';
export 'rank_team_model.dart';

class RankTeamWidget extends StatefulWidget {
  const RankTeamWidget({
    super.key,
  ...
  @override
  State<RankTeamWidget> createState() => _RankTeamWidgetState();
}

class _RankTeamWidgetState extends State<RankTeamWidget> {
  late RankTeamModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RankTeamModel());
  }
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Visibility(
                                                              visible: (containerTeamsRecord.leagueValue != 'autres') &&
                                              ...
                                              children: List.generate(
                                                ...
                                                return Row(
                                                  mainAxisSize:
                                                      MainAxisSize.max,
                                                  children: [
                                                    if ((containerTeamsRecord.sportValue ==
                                                            'mma') ||
                                                        (containerTeamsRecord
                                                                .sportValue ==
                                                            'boxe') ||
