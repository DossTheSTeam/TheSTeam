...
class ModifBetPageWidget extends StatefulWidget {
  const ModifBetPageWidget({
    super.key,
    required this.betRef,
  });
...
class _ModifBetPageWidgetState extends State<ModifBetPageWidget> {
  late ModifBetPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModifBetPageModel());
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    if (columnEventEventsRecord.sportValue !=
                                        'sports.meca')
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 5.0, 0.0, 0.0),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                if (modifBetPageBetsRecord.first != '')
                                  Text(
                                    valueOrDefault<String>(
                                      modifBetPageBetsRecord.first,
                                      'first',
                                    ),
                                    maxLines: 2,
                                    style: FlutterFlowTheme.of(context)
                                ...
                                if (modifBetPageBetsRecord.podium != '')
                                  Text(
                                    valueOrDefault<String>(
                                      modifBetPageBetsRecord.podium,
                                      'podium',
                                    ),
                                    maxLines: 2,
                                    style: FlutterFlowTheme.of(context)
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      await modifBetPageBetsRecord.reference
                                          .update(createBetsRecordData(
