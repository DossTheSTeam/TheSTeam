                                ...
                                Column(
                                  ...
                                  children: [
                                    if ((valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'x6pv57o8' /* Suivre des membres de clubs ou... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if ((valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'i9lecn9f' /* Follow club members or create ... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'klbjry91' /* Clubmitgliedern folgen oder Ne... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '0ajimupv' /* Sigue a los miembros del club ... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '4clakv9i' /* Segui i membri del club o crea... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'i477an4d' /* Siga os membros do clube ou cr... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                                                      ...
                                                                      children: [
                                                                        if (columnEventsRecord.sportValue !=
                                                                          ...
                                                                          StreamBuilder<
                                                                              TeamsRecord>(
                                                                            stream:
                                                                                TeamsRecord.getDocument(columnEventsRecord.teamdomRef!),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
                                                                              if (!snapshot.hasData) {
                                                                        ...
                                                                        if (columnEventsRecord.sportValue !=
                                                                          ...
                                                                          StreamBuilder<
                                                                              TeamsRecord>(
                                                                            stream:
                                                                                TeamsRecord.getDocument(columnEventsRecord.teamextRef!),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
                                                                              if (!snapshot.hasData) {
