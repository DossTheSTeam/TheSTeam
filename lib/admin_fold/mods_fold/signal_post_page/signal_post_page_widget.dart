                          ...
                          Padding(
                            ...
                            child: StreamBuilder<UsersRecord>(
                              stream: UsersRecord.getDocument(
                                  signalPostPageMyNotificationsRecord.userRef!),
                              builder: (context, snapshot) {
                                // Customize what your widget looks like when it's loading.
                                if (!snapshot.hasData) {
                                  return Center(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                columnNotifUserUsersRecord.stock
                                                    .toString(),
                                                maxLines: 1,
                                                style:
                                                    FlutterFlowTheme.of(context)
                          ...
                          Padding(
                            ...
                            child: StreamBuilder<UsersRecord>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                final columnMemberUsersRecord = snapshot.data!;
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await columnPostPostsRecord.reference.update({
                                    ...mapToFirestore(
                                      {
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await MyNotificationsRecord.createDoc(
                                      ...
                                      .set({
                                    ...createMyNotificationsRecordData(
                                      text: 'Carton confirmé et suppression :',
                                      moderator: currentUserReference,
                                      post: columnPostPostsRecord.reference,
                                      seen: false,
                                      textFouls:
                                  ...
                                  await MyNotificationsRecord.createDoc(
                                      ...
                                      .set({
                                    ...createMyNotificationsRecordData(
                                      text: 'Suppression de votre actualité : ',
                                      moderator: currentUserReference,
                                      post: columnPostPostsRecord.reference,
                                      seen: false,
                                      textFouls:
