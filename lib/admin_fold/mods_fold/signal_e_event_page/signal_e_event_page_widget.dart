...
class SignalEEventPageWidget extends StatefulWidget {
  const SignalEEventPageWidget({
    super.key,
...
class _SignalEEventPageWidgetState extends State<SignalEEventPageWidget> {
  late SignalEEventPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignalEEventPageModel());
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          StreamBuilder<TeamsRecord>(
                            stream: TeamsRecord.getDocument(
                                signalEEventPageMyNotificationsRecord.teamRef!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'soea8m2h' /* Dénonce un résultat mal paramé... */,
                                ),
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'rd6xh1yh' /* Mettre une pénalité à la E Tea... */,
                                ),
                                textAlign: TextAlign.center,
                                maxLines: 10,
                                style: FlutterFlowTheme.of(context)
                          ...
                          StreamBuilder<EventsRecord>(
                            stream: EventsRecord.getDocument(
                                signalEEventPageMyNotificationsRecord.eEvent!),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
                                return Center(
                              ...
                              return Column(
                                ...
                                children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'vdyzf5ud' /* Après vérifications ci-dessous... */,
                                                    ),
                                                    textAlign: TextAlign.center,
                                                    maxLines: 3,
                                              ...
                                              Align(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'ywtybclj' /* Si oui, pour quelle E Team ? */,
                                                    ),
                                                    maxLines: 1,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                        ...
                                        Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'bc9d307n' /* Selon E Team ayant paramétré e... */,
                                            ),
                                            maxLines: 2,
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                        ...
                                        if (columnEventEventsRecord.seenScore ==
                                            true)
                                          Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  Align(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'zes657d6' /* Selon E Team envoyant la notif... */,
                                      ),
                                      maxLines: 2,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'i8425mkt' /* Ci-dessous la photo prouvant s... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'ipv5cwv0' /* Bien vérifier que les équipes
... */
                                          ,
                                        ),
                                        textAlign: TextAlign.center,
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'msiqq4q2' /* Gagnant de la rencontre ? */,
                                              ),
                                              maxLines: 1,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: FFButtonWidget(
                                                    ...
                                                    text: FFLocalizations.of(
                                                            context)
                                                        .getText(
                                                      'eb7huetn' /* Valider modifications */,
                                                    ),
                                            ...
                                            child: Padding(
                                              ...
                                              child: FFButtonWidget(
                                                ...
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'b06qk306' /* Publier le résultat Dom */,
                                                ),
                                                options: FFButtonOptions(
                                                  width: 350.0,
                                                  height: 50.0,
                                            ...
                                            child: Padding(
                                              ...
                                              child: FFButtonWidget(
                                                ...
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'hppn1hli' /* Publier le résultat Draw */,
                                                ),
                                                options: FFButtonOptions(
                                                  width: 350.0,
                                                  height: 50.0,
                                            ...
                                            child: Padding(
                                              ...
                                              child: FFButtonWidget(
                                                ...
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'e4swh254' /* Publier le résultat Ext */,
                                                ),
                                                options: FFButtonOptions(
                                                  width: 350.0,
                                                  height: 50.0,
