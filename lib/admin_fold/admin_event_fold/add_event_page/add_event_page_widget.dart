                    ...
                    children: [
                      Container(
                        ...
                        child: FlutterFlowCountController(
                          ...
                          updateCount: (count) =>
                              safeSetState(() => _model.countHourValue = count),
                          stepSize: 1,
                          minimum: 0,
                          maximum: 23,
                        ),
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    8.0, 0.0, 8.0, 0.0),
                                child: TextFormField(
                                  controller: _model.numWeekFieldTextController,
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          await eventsRecordReference
                                            ...
                                            teamdom: columnTeamDomRefTeamsRecord
                                                ?.value,
                      ...
                      if (_model.dropTeamExtValue != null &&
                        ...
                        StreamBuilder<List<TeamsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<TeamsRecord> columnTeamExtRefTeamsRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
