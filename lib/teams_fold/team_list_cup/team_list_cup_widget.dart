...
class TeamListCupWidget extends StatefulWidget {
  ...
  static String routeName = 'TeamListCup';
  static String routePath = '/teamListCup';
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      if ((valueOrDefault(
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'fwx8r92p' /* Choisir la coupe ci-dessous */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                      ...
                                      if (valueOrDefault(
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'cni7zva0' /* Wählen Sie unten den Schnitt */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                      ...
                                      if (valueOrDefault(
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '51w8fmaz' /* Elige el corte a continuación */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                      ...
                                      if (valueOrDefault(
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '3t0axibd' /* Scegli il taglio qui sotto */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                      ...
                                      if (valueOrDefault(
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'kvq334an' /* Escolha o corte abaixo */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                              ...
                              Row(
                                ...
                                children: [
                                  FlutterFlowDropDown<String>(
                                    ...
                                    optionLabels: [
                                      FFLocalizations.of(context).getText(
                                        '32f09bpw' /* Champions League */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'bpwipqr4' /* Europa League */,
                                      ),
                                      FFLocalizations.of(context).getText(
                                        'r4v7bjb9' /* Conférence League */,
                                      )
                                    ],
