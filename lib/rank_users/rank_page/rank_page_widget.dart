...
class _RankPageWidgetState extends State<RankPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RankPageModel());
  }
            ...
            child: Stack(
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(0.0, 110.0, 0.0, 50.0),
                                                      ...
                                                      AuthUserStreamWidget(
                                                        builder: (context) =>
                                                          ...
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'c7b5mm0d' /* Durchschnittliche Bewertung */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.center,
                                                          style: FlutterFlowTheme
