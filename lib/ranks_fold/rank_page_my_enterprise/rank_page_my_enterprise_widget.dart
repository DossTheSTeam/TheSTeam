                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child:
                                          ...
                                          stream:
                                              TeamConferenceRecord.getDocument(
                                                  rowTeamsRecord.conference!),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            if (!snapshot.hasData) {
                                              return Center(
                                            ...
                                            return Row(
                                              ...
                                              children: [
                                                ...
                                                if (rowTeamConferenceRecord.fans
                                                    .contains(
                                                        currentUserReference))
                                                  Align(
                                                    alignment:
                                                    ...
                                                    if (valueOrDefault(
                                                      ...
                                                      Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'oqx69lgx' /* Durchschnittliche Bewertung */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                                                ...
                                                                Align(
                                                                  ...
                                                                  child: Text(
                                                                    valueOrDefault<
                                                                      ...
                                                                      functions
                                                                          .averageGoals(
                                                                              columnUsersEarningsScrollUsersRecord.totalBets,
