                                            ...
                                            children: [
                                              ...
                                              if (valueOrDefault(
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'aev16hdh' /* As minhas estatísticas */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelLarge
                                            ...
                                            children: [
                                              ...
                                              if (valueOrDefault(
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '9y2r68vp' /* A minha classificação */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelLarge
                                            ...
                                            children: [
                                              ...
                                              if (valueOrDefault(
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'qhzkyund' /* A minha E classificação */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelLarge
...
mein profil */
                              ...
                              if (valueOrDefault(
                                ...
                                AuthUserStreamWidget(
                                  builder: (context) => Text(
                                    FFLocalizations.of(context).getText(
                                      'fpx3fkie' /* Modifica il mio profilo */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .headlineSmall
                        ...
                        builder: (context) => Column(
                          ...
                          children: [
                            if ((valueOrDefault(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '0l7a2cou' /* Les informations suivantes son... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                            ...
                            if ((valueOrDefault(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '4t1wpy04' /* The following information is c... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                            ...
                            if (valueOrDefault(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'uomxbqvg' /* Die folgenden Informationen si... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                            ...
                            if (valueOrDefault(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'x2brx8du' /* La siguiente información es co... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                            ...
                            if (valueOrDefault(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'zailyhn1' /* Le seguenti informazioni sono ... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                            ...
                            if (valueOrDefault(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '346x1l63' /* As informações que se seguem s... */,
                                ),
                                textAlign: TextAlign.center,
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                        ...
                        builder: (context) => Column(
                          ...
                          children: [
                            if ((valueOrDefault(
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  '1tahxdgh' /* Votre ID d'utilisateur
(visibl... */
                                  ,
                                ),
                                textAlign: TextAlign.center,
...
(também vi... */
                  ...
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(30.0, 100.0, 0.0, 50.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
