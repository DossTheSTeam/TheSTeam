                                ...
                                Column(
                                  ...
                                  children: [
                                    if ((valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'uk7gjdfz' /* Filtrer les événements par spo... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if ((valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'icjex18r' /* Filter events by sport and dat... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '7h1ul2g7' /* Ereignisse filtern nach Sporta... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'd4m6nx4y' /* Filtrar eventos por deporte y ... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'qq4sazry' /* Filtra eventi per sport e per ... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                    ...
                                    if (valueOrDefault(
                                      ...
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'uyrgdppl' /* Filtrar eventos por desporto e... */,
                                        ),
                                        textAlign: TextAlign.center,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                ...
                                FutureBuilder<int>(
                                  future: queryEventsRecordCount(
                                    queryBuilder: (eventsRecord) => eventsRecord
                                        ...
                                        .where(
                                          'sport_value',
                                          isEqualTo: 'esport.football' != ''
                                              ? 'esport.football'
                                              : null,
                                        )
                                        .where(
                                          'statut',
                                          isEqualTo: !_model.showStatutFilter!,
                                        ),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                              ...
                              children: List.generate(
                                ...
                                final columnEventsEventsRecord =
                                    columnEventsEventsRecordList[
                                        columnEventsIndex];
                                return Visibility(
                                  visible: (columnEventsEventsRecord.statut ==
                                          !_model.showStatutFilter!) &&
                                      (columnEventsEventsRecord.esport ==
                                          valueOrDefault<bool>(
