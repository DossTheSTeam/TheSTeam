...
import 'leagu_events_list_add3_bet_model.dart';
export 'leagu_events_list_add3_bet_model.dart';

class LeaguEventsListAdd3BetWidget extends StatefulWidget {
  const LeaguEventsListAdd3BetWidget({
    super.key,
  ...
  static String routeName = 'LeaguEventsListAdd3Bet';
  static String routePath = '/leaguEventsListAdd3Bet';

  @override
  State<LeaguEventsListAdd3BetWidget> createState() =>
      _LeaguEventsListAdd3BetWidgetState();
}

class _LeaguEventsListAdd3BetWidgetState
    extends State<LeaguEventsListAdd3BetWidget> {
  late LeaguEventsListAdd3BetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeaguEventsListAdd3BetModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EventsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final leaguEventsListAdd3BetEventsRecord = snapshot.data!;
              ...
              body: Visibility(
                ...
                child: Stack(
                  children: [
                                    ...
                                    child: Container(
                                      ...
                                      child: Align(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            if ((leaguEventsListAdd3BetEventsRecord.leagueValue ==
                                                    'champions.league') ||
                                                (leaguEventsListAdd3BetEventsRecord.leagueValue ==
                                                    'champions.cup') ||
                                            ...
                                            if ((leaguEventsListAdd3BetEventsRecord
                                                        .leagueValue ==
                                                    'ligue.1') ||
                                                (leaguEventsListAdd3BetEventsRecord
                                                        .leagueValue ==
                                            ...
                                            if ((leaguEventsListAdd3BetEventsRecord.leagueValue == 'nba') ||
                                                (leaguEventsListAdd3BetEventsRecord
                                                        .leagueValue ==
                                                    'ufc') ||
                                                (leaguEventsListAdd3BetEventsRecord
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 210.0, 0.0, 50.0),
