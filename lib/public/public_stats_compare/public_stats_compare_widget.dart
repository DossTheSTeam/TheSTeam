              ...
              body: Padding(
                ...
                child: Stack(
                  children: [
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 120.0, 0.0, 50.0),
                                                    ...
                                                    AuthUserStreamWidget(
                                                      builder: (context) =>
                                                        ...
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'fddhgg5p' /* Durchschnittliche Bewertung */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
                                                    ...
                                                    AuthUserStreamWidget(
                                                      builder: (context) =>
                                                        ...
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'yfteppuu' /* Durchschnittliche Bewertung */,
                                                        ),
                                                        textAlign:
                                                            TextAlign.center,
                                                        style:
