...
class SignalPostPageWidget extends StatefulWidget {
  ...
  static String routeName = 'SignalPostPage';
  static String routePath = '/signalPostPage';
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'lw73srn2' /* veut mettre un carton rouge à */,
                                    ),
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '269tap51' /* Pour la raison suivante */,
                                    ),
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '28gqe17d' /* Dans l'actualité suivante */,
                                    ),
                                    textAlign: TextAlign.start,
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await columnPostPostsRecord.member!
                                          .update({
                                        ...mapToFirestore(
                                          {
                                            'stock':
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'e4ea0mql' /* pour la raison suivante */,
                                    ),
                                    textAlign: TextAlign.center,
                                    style: FlutterFlowTheme.of(context)
                                        .titleMedium
                              ...
                              FlutterFlowDropDown<String>(
                                ...
                                optionLabels: [
                                  FFLocalizations.of(context).getText(
                                    'pnfbx8en' /* Manque d'elements */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    'bd2rby2h' /* Chambrage  */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    '2eol49yz' /* Pas mentionnés dans CGU */,
                                  )
                                ],
