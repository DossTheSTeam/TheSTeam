...
import '/teams/color_team/color_team_widget.dart';
import '/index.dart';
...
class ModifTeamPageWidget extends StatefulWidget {
  const ModifTeamPageWidget({
    super.key,
...
class _ModifTeamPageWidgetState extends State<ModifTeamPageWidget> {
  late ModifTeamPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModifTeamPageModel());
    ...
    _model.l2MFieldTextController1 ??= TextEditingController();
    _model.l2MFieldFocusNode1 ??= FocusNode();
    ...
    _model.l2MFieldTextController2 ??= TextEditingController();
    _model.l2MFieldFocusNode2 ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TeamsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final modifTeamPageTeamsRecord = snapshot.data!;
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            modifTeamPageTeamsRecord.reference.id,
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  font: GoogleFonts.poppins(
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.teamNameFieldTextController,
                                    ...
                                    validator: _model
                                        .teamNameFieldTextControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ),
                            ...
                            children: [
                              Expanded(
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.teamvalueFieldTextController,
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await widget.teamRef!
                                        ...
                                        value: _model
                                            .teamvalueFieldTextController.text,
                                      ));
                                      safeSetState(() {
                                        _model.teamNameFieldTextController
                                            ?.clear();
...
photo de profil */
                                        ...
                                        onTap: () async {
                                          ...
                                          if (selectedMedia != null &&
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadData92n =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                    selectedMedia.length &&
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_uploadData92n =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_uploadData92n =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                          ...
                          if (modifTeamPageTeamsRecord.sportValue == 'mma')
                            Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Align(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        modifTeamPageTeamsRecord.divisionValue,
                                        maxLines: 1,
                                        style: FlutterFlowTheme.of(context)
                                            .titleSmall
                                            .override(
                                    ...
                                    Padding(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        optionLabels: [
                                          ...
                                          FFLocalizations.of(context).getText(
                                            'bxt49z64' /* Bantam Weight */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'ri0u0lq4' /* Feather Weight */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'ydmiuq55' /* Light Weight */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            '6gml11rc' /* Welter Weight */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            '7gebts4c' /* Middle Weight */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            '6zuighsg' /* Light Heavy Weight */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            '8o3m0k76' /* Heavy Weight */,
                                          )
                                        ],
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    mainAxisAlignment:
                                        MainAxisAlignment.spaceBetween,
                                    children: [
                                      if (modifTeamPageTeamsRecord.champion ==
                                          true)
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '20yhtvpg' /* Champion */,
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  modifTeamPageTeamsRecord.leagueValue,
                                  maxLines: 1,
                                  style: FlutterFlowTheme.of(context)
                                      .titleSmall
                                      .override(
                                    ...
                                    Padding(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        ...
                                        optionLabels: [
                                          ...
                                          FFLocalizations.of(context).getText(
                                            'p3rwg5en' /* Pays Football */,
                                          ),
                                          FFLocalizations.of(context).getText(
                                            'lssctlsm' /* Autres - France */,
                                          )
                                        ],
                                        onChanged: (val) => safeSetState(() =>
                          ...
                          if ((modifTeamPageTeamsRecord.sportValue ==
                                  'football') ||
                              (modifTeamPageTeamsRecord.sportValue == 'rugby'))
                            Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                Align(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              child: Icon(
                                                Icons.send_rounded,
                                                color: modifTeamPageTeamsRecord
                                                    .color1,
                                                size: 30.0,
                                              ),
                                            ),
                                          ...
                                          Padding(
                                            ...
                                            child: FlutterFlowDropDown<String>(
                                              ...
                                              optionLabels: [
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'yualjao5' /* Champions Cup */,
                                                )
                                              ],
                                              onChanged: (val) => safeSetState(
                                                  () => _model
                                                      .dropRugbyCupValue = val),
                                              width: 200.0,
                                              height: 40.0,
                                              textStyle:
                                                  FlutterFlowTheme.of(context)
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            modifTeamPageTeamsRecord.totalGames
                                                .toString(),
                                            '0',
                                          ),
                                          maxLines: 1,
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            modifTeamPageTeamsRecord.points
                                                .toString(),
                                            '0',
                                          ),
                                          maxLines: 1,
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Text(
                                          valueOrDefault<String>(
                                            modifTeamPageTeamsRecord.looses
                                                .toString(),
                                            '0',
                                          ),
                                          maxLines: 1,
                                                  ...
                                                  child: TextFormField(
                                                    ...
                                                    keyboardType:
                                                        const TextInputType
                                                            ...
                                                            decimal: true),
                                                    validator: _model
                                                        .l2MFieldTextController1Validator
                                                        .asValidator(context),
                                                  ),
                                                ),
                                              ),
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      keyboardType:
                                                          const TextInputType
                                                              ...
                                                              decimal: true),
                                                      validator: _model
                                                          .l2MFieldTextController2Validator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
