                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (teamStatsTeamsRecord.sportValue == 'mma')
                                    Align(
                                      ...
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 5.0, 0.0, 10.0),
                                        child: Text(
                                          teamStatsTeamsRecord.divisionValue,
...
equipas marcam */
                                        ...
                                        if ((teamStatsTeamsRecord.sportValue !=
                                                'mma') &&
                                            (teamStatsTeamsRecord.sportValue !=
                                                'sports.meca') &&
                                            (teamStatsTeamsRecord.sportValue !=
                                                'tennis'))
                                          Container(
...
equipas marcam */
                            ...
                            if (teamStatsTeamsRecord.esport == true)
                              Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text(
                                    valueOrDefault<String>(
                                      teamStatsTeamsRecord.redCards.toString(),
                                      '0',
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .titleSmall
